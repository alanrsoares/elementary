...
/***/ function(module, exports, __webpack_require__) {
	...
	var react, todoApp, $, index;
	react = __webpack_require__(3);
	todoApp = __webpack_require__(1);
	$ = __webpack_require__(2);
	index = __webpack_require__(9);
	react.render($(todoApp), document.querySelector('.todoapp'));

/***/ },
/* 1 */
/***/ function(module, exports, __webpack_require__) {

	var react, $, footer, header, mainSection, todoStore, fluxy, getTodoState;
	react = __webpack_require__(3);
	$ = __webpack_require__(2);
	footer = __webpack_require__(4);
	header = __webpack_require__(5);
	mainSection = __webpack_require__(6);
	todoStore = __webpack_require__(7);
	fluxy = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react, htmlTags, slice, builder, reducer, elementary;
	react = __webpack_require__(3);
	htmlTags = __webpack_require__(8);
	...
	builder = function(tag){
	  ...
	  return react.createElement.apply(this, [tag].concat(args));
	};
	reducer = function(reduced, tag){
	  reduced[tag] = function(){
	    var args;
	    args = slice(arguments);
	    return builder.apply(this, [tag].concat(args));
	  };
	  return reduced;
	};
	elementary = htmlTags.reduce(reducer, builder);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react, $, todoActions, types;
	react = __webpack_require__(3);
	$ = __webpack_require__(2);
	todoActions = __webpack_require__(12);
	...
	module.exports = react.createClass({
	   ...
	   */,
	  render: function(){
	    var allTodos, total, completed, itemsLeft, itemsLeftPlural, itemsLeftPhrase, clearCompletedButton;
	    allTodos = this.props.allTodos;
	    total = Object.keys(allTodos).length;
	    if (total === 0) {
	      return null;
	    }
	    completed = Object.keys(allTodos).map(function(key){
	      return allTodos[key];
	    }).filter(function(todo){
	      return todo.complete;
	    }).length;
	    itemsLeft = total - completed;
	    itemsLeftPlural = itemsLeft > 1 ? 'items' : 'item';
	    itemsLeftPhrase = itemsLeft + " " + itemsLeftPlural + " left";
	    clearCompletedButton = completed ? $.button({
	      className: 'clear-completed',
	      onClick: this._onClearCompletedClick
	    }, 'Clear completed') : void 8;
	    return $.footer({
	      className: 'footer'
	    }, $.span({
	      className: 'todo-count'
	    }, $.strong({}, itemsLeftPhrase)), clearCompletedButton);
	  },
	  _onClearCompletedClick: function(){
	    return todoActions.destroyCompleted();
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ref$, Component, types, $, todoActions, todoTextInput, Header;
	ref$ = __webpack_require__(3), Component = ref$.Component, types = ref$.PropTypes;
	$ = __webpack_require__(2);
	todoActions = __webpack_require__(12);
	todoTextInput = __webpack_require__(14);
	module.exports = Header = (function(superclass){
	  ...
	  prototype.render = function(){
	    return $.header({
	      className: 'header'
	    }, $.h1({}, this.props.title), $(todoTextInput, {
	      className: 'new-todo',
	      placeholder: 'What needs to be done?',
	      onSave: this._onSave
	    }));
	  };
	  prototype._onSave = function(text){
	    return todoActions.create(text);
	  };
	  function Header(){
	    Header.superclass.apply(this, arguments);
	  }
	  return Header;
	}(Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react, $, todoItem, todoActions, types;
	react = __webpack_require__(3);
	$ = __webpack_require__(2);
	todoItem = __webpack_require__(13);
	todoActions = __webpack_require__(12);
	types = react.PropTypes;
	module.exports = react.createClass({
	  propTypes: {
	  ...
	  render: function(){
	    var allTodos, keys, todos;
	    allTodos = this.props.allTodos;
	    keys = Object.keys(allTodos);
	    if (!keys.length) {
	      return null;
	    }
	    todos = keys.map(function(key){
	      return $(todoItem, {
	        key: key,
	        todo: allTodos[key]
	      });
	    ...
	    return $.section({
	      ...
	      checked: this.props.areAllComplete ? 'checked' : void 8
	    }), $.label({
	      htmlFor: 'toggle-all'
	  ...
	  _onToggleCompleteAll: function(){
	    return todoActions.toggleCompleteAll();
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var alt, merge, todoActions, todoStore;
	alt = __webpack_require__(15);
	merge = __webpack_require__(16);
	todoActions = __webpack_require__(12);
	todoStore = (function(){
	  todoStore.displayName = 'todoStore';
	  var prototype = todoStore.prototype, constructor = todoStore;
	  function todoStore(){
	  ...
	  prototype.update = function(id, updates){
	    if (this.todos[id] && updates) {
	      return this.todos[id] = merge(this.todos[id], updates);
	    }
	  };
	  prototype.updateAll = function(updates){
	    var self;
	    self = this;
	    return function(it){
	      return it.map(function(id){
	        return self.update(id, updates);
	      });
	    }(
	    Object.keys(self.todos));
	  };
	  prototype.onCreate = function(text){
	    var id;
	    text = text.trim();
	    if (text === '') {
	      return false;
	  ...
	  prototype.onUpdateText = function(x){
	    var id, text;
	    id = x.id, text = x.text;
	    text = text ? text.trim() : '';
	    if (text === '') {
	  ...
	  prototype.onToggleComplete = function(id){
	    var complete;
	    complete = !this.todos[id].complete;
	    return this.update(id, {
	      complete: complete
	    });
	  };
	  prototype.onToggleCompleteAll = function(){
	    var complete;
	    complete = !constructor.areAllComplete({
	      todos: this.todos
	    });
	  ...
	  prototype.onDestroy = function(id){
	    var ref$, ref1$;
	    return ref1$ = (ref$ = this.todos)[id], delete ref$[id], ref1$;
	  };
	  prototype.onDestroyCompleted = function(){
	    var self;
	    self = this;
	    return Object.keys(self.todos).filter(function(id){
	      return self.todos[id].complete;
	    }).map(function(id){
	      return self.onDestroy(id);
	    });
	  };
	  todoStore.areAllComplete = function(state){
	    var todos;
	    todos = (state || this.getState()).todos;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * }
	 */
	var Subscribe = __webpack_require__(38)
...
/***/ function(module, exports, __webpack_require__) {
	...
	todoActions = (function(){
	  ...
	  var prototype = todoActions.prototype, constructor = todoActions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react, cx, $, todoActions, todoTextInput, types;
	react = __webpack_require__(3);
	cx = __webpack_require__(39);
	$ = __webpack_require__(2);
	todoActions = __webpack_require__(12);
	todoTextInput = __webpack_require__(14);
	types = react.PropTypes;
	module.exports = react.createClass({
	  ...
	  _onToggleComplete: function(){
	    return todoActions.toggleComplete(this.props.todo.id);
	  },
	  ...
	  _onDestroyClick: function(){
	    return todoActions.destroy(this.props.todo.id);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = _interopRequire(__webpack_require__(107));

	var Symbol = _interopRequire(__webpack_require__(152));

	var assign = _interopRequire(__webpack_require__(108));
